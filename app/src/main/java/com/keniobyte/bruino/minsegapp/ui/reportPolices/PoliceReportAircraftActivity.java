...
public class PoliceReportAircraftActivity extends ActionBarActivity {
    ...
    private boolean flag_captcha = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //hides perpetrator's edit text
        View editTextNamePerpetrator = findViewById(R.id.editTextNamePerpetrator);
        ((ViewGroup) editTextNamePerpetrator.getParent()).removeView(editTextNamePerpetrator);
    ...
    private void captchaVerify(){
        final AlertDialog.Builder alertdialog = new AlertDialog.Builder(PoliceReportAircraftActivity.this);
        ...
        alertdialog.setPositiveButton("ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(final DialogInterface dialog, int which) {
                if (flag_captcha && !editTextCaptcha.getText().toString().isEmpty()){
    ...
    private void sendReport() throws FileNotFoundException{
        ...
        // Report type
        requestParams.put("report_type", "suspect_aircraft");
    ...
    //Updates date information button
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            if(uriImage.getScheme().equals(SCHEME_CONTENT)){
                Picasso.with(mContext).load(new File(getRealPathImage(uriImage))).fit().centerCrop().into(imageViewEvidence);
            } else {
    ...
    private AlertDialog createAlertDialog(){
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(PoliceReportAircraftActivity.this);
