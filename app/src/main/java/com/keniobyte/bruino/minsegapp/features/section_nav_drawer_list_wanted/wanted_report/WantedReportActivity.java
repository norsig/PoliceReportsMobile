...
public class WantedReportActivity extends AppCompatActivity implements IWantedReportView {
    ...
    private WantedReportPresenter presenter;
    private WantedReportInteractor interactor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        interactor = new WantedReportInteractor(context);
        presenter = new WantedReportPresenter(interactor);
    ...
    @Override
    public void sendWantedReportMessageError(int rStringMessage) {
    ...
    @Override
    public void sendWantedReportMessageSuccess() {
        new AlertDialog.Builder(this)
